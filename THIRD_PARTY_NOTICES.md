...
license terms in the original repository and are not copied into this project.

The copied/adapted Buzzrito DSP files are:

- `cards/buzzrito/buzzrito_dsp.h`
- `cards/buzzrito/tanh_table.c`
- `cards/buzzrito/tanh_table.h`
- `cards/buzzrito/sintab.h`

## Workshop Computer ComputerCard
