...
private:
                                                   ...
                                                   int32_t boc_amount, int32_t boc_speed)
    {
        ...
        // BOC originally advances once for each 64-sample DSP block. Limit
        // the first trial to one eighth depth, but preserve its shared
        // sub/comb and half-depth saw routing.
        const int32_t bounded_boc_amount = clampi(boc_amount, 0, 4096) >> 3;
