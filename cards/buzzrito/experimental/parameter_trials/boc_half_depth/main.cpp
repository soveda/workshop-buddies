...
private:
                                                   ...
                                                   int32_t boc_amount, int32_t boc_speed)
    {
        ...
        // calibration trial uses half the original depth and preserves its
        // shared sub/comb and half-depth saw routing.
        const int32_t bounded_boc_amount = clampi(boc_amount, 0, 4096) >> 1;
