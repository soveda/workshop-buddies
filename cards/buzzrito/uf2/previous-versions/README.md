...
- `pre_wobble`: earlier stable version without wobble.
- `switch_up_motion_passed`: duplicate of the current passed Switch Up motion image, retained with its source fallback.
