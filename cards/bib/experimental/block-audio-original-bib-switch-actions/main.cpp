// Workshop block-audio original Bib switch-actions experiment.
//
...
BibParameters UpdateBibParameters(const ControlSnapshot &controls)
{
    ...
    pageValues[mode][0] = ClampControl(controls.knobs[1]);
    pageValues[mode][1] = ClampControl(controls.knobs[2]);
