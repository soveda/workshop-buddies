# Workshop Block-Audio Driver: Control Snapshot LED Fix
...
The output is `build/workshop_block_audio_controls_led_test.uf2`.
...
5. Send repeated gates to Pulse In 1. LED 2 should flash briefly once for each
